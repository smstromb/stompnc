...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DawnDonator'
        db.create_table('donate_dawndonator', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('donate', ['DawnDonator'])


    def backwards(self, orm):
        # Deleting model 'DawnDonator'
        db.delete_table('donate_dawndonator')
    ...
    models = {
        ...
        'donate.donator': {
            ...
            'donate_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 1, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
